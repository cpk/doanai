...
- [~] GĐ3 (phần chạy thật, còn lại): RBAC VLM trên seeded build (`rq3-seeded-bugs`, kỳ vọng R1–R5 fail) + benchmark RQ4 — **chặn bởi API key** (máy Windows chưa có `tests-vlm/.env`, tạo lại từ `.env.example`)

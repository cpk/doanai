...
- [~] GĐ4: Thực nghiệm + phân tích (07/09) — **phần chạy tự động xong sớm 09/07**
  ...
  - ✅ 09/07: **Nháp Chương 4 xong**: `docs/chuong4-draft.md` (thiết lập, kết quả 4 RQ, thảo luận trade-off, 6 mục Threats to Validity; các chỗ ⚠️ TODO chờ quyết định GVHD/chèn vào template khoa).

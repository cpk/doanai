...
- [~] GĐ4: Thực nghiệm + phân tích (07/09) — **phần chạy tự động xong sớm 09/07**
  ...
  - ⏳ Còn lại GĐ4: đo thời gian phục hồi của agent trên branch `rq2-agent-v2`/`rq2-agent-v3` → điền `results/rq2-maintenance.md` + Chương 4 mục 4.3 + panel thời gian vào `fig-rq2-maintenance.png`; trình bày thiết kế với GVHD theo `docs/gvhd-trao-doi.md`.

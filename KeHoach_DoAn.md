...
- [~] GĐ4: Thực nghiệm + phân tích (07/09) — **phần chạy tự động xong sớm 09/07**
  ...
  - ⏳ Còn lại GĐ4: (a) **RQ2 maintenance cost** — người dùng tự sửa 2 bộ test cho V2/V3 theo quy trình mục 2 (locator hỏng 9 test trên V2 + 6 trên V3; VLM 0 test hỏng → đo phần locator là chính); (b) phân tích + vẽ biểu đồ (tuần 9); (c) nháp Chương 4.

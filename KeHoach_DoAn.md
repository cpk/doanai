...
- [~] GĐ5: Báo cáo + slide + repo public (20/09) — **bắt đầu sớm 09/07**
  ...
  - ⏳ Còn lại GĐ5 (chi tiết ở `docs/bao-cao/00-khung-bao-cao.md`): sinh viên duyệt/sửa giọng văn từng chương (đối chiếu số liệu 4 bài ⭐ ở Chương 2); ghép template .docx khoa (mục lục, tóm tắt, định dạng trích dẫn); vẽ sơ đồ Hình 3.1 + dựng Bảng 2.1; slide bảo vệ + demo; chuyển repo public; xoay API key.
